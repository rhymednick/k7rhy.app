    ...
    return (
        <main className="flex min-h-screen flex-col justify-between pl-4 pr-4 pt-4 md:pl-24 md:pr-24 md:pt-12">
            <div className="space-y-2">
                <h1
                    className={cn(
                        'scroll-m-20 text-3xl pb-3 md:pb-6 font-bold tracking-tight'
                    )}
                >
                    Products
                </h1>
                <Card className="mb-2 mt-2 md:mb-4 md:mt-4">
                        ...
                        <CardTitle>
                            ...
                            <div className="block md:inline">
                                ...
                                >
                                    <Link
                                        target="_blank"
                                        href="https://ca0f39-2e.myshopify.com/products/20w-dummy-load-kit?utm_source=copyToPasteBoard&utm_medium=product-links&utm_content=web"
                                    >
                    ...
                    <CardContent>
                        <CardDescription className="mb-2 md:mb-4">
                            <Balancer>
                                Unleash the full potential of your ham radio
                                setup with our 20W Dummy Load Kit, designed for
                                both novice and experienced operators. Whether
                                you’re testing, adjusting, or simply
                                experimenting with your equipment, this kit
                                provides the perfect solution for ensuring your
                                transmitter is optimally configured without
                                transmitting signals on the air. The kit is
                                shipped unassembled and without an enclosure.
                            </Balancer>
                        </CardDescription>
                        ...
                        <h2
                            className={cn(
                                'text-2xl pb-2 font-bold tracking-tight'
                            )}
                        >
                            Key Features
                        </h2>
                        ...
                        <h2
                            className={cn(
                                'scroll-m-20 text-2xl pt-3 md:pt-6 pb-2 font-bold tracking-tight'
                            )}
                        >
                            Specifications
                        </h2>
