...
export default function HamRadioPage() {
    return (
        <main className="flex min-h-screen flex-col gap-10 px-4 pb-24 pt-8 md:px-12 lg:px-20">
            <PageHero badge="Ham Radio" title="Build, measure, and understand radio gear." description="Kits, experiments, and practical references for the amateur-radio bench." actions={<Button asChild><Link href="/shop/ham-radio-kits">Shop ham radio kits</Link></Button>} />
            <DocIndexCard
