...
export async function generateMetadata() {
    try {
        const { frontmatter } = loadRelayPlatformSectionPage(['body', 'bonding']);
        return {
...
export default async function RelayBodyBondingPage() {
    const { content, frontmatter } = loadRelayPlatformSectionPage(['body', 'bonding']);
    const breadcrumbs = [{ label: 'Guitars', href: '/guitars' }, { label: 'Relay', href: '/guitars/relay' }, { label: 'Body', href: '/guitars/relay/body' }, { label: 'Bonding' }];
    return (
