...
const docProcedureSteps: DocProcedureProps['docProcedureSteps'] = [
    ...
    },
    {
        ...
        description: 'Install the resistors on the PCB at the locations marked R1-R8. All the resistors are identical,' + " so they can go in any of the marked spaces; orientation isn't important since the resistors are not polarized. " + "If you're experienced with electronics, you can install all the resistors on your own now. " + "If you're new to soldering, follow along with my instructions.",
        substeps: [
            {
                text: 'Prepare the resistors',
