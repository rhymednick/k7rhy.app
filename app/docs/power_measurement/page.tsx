...
const Page = () => {
    return (
        <DocPage title={DocTitle} subTitle={DocSubTitle} breadcrumbs={<MyBreadcrumbs items={breadcrumbItems} />}>
            <div>All K7RHY dummy load kits are designed with test pads that are used to measure the output power of your radio with a multimeter. The power is measured, while transmitting, as a voltage that is converted to watts using a formula derived from Ohm's Law.</div>
