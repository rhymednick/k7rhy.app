            ...
            <section className="relative isolate overflow-hidden rounded-3xl border border-border/60 bg-white/80 px-6 py-12 shadow-lg ring-1 ring-black/5 dark:border-slate-800 dark:bg-slate-950/70 dark:ring-white/10 md:px-12">
                ...
                <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-center">
                    <div className="flex-1 space-y-6">
                        <Badge className="w-fit border border-slate-300/70 bg-white/80 text-xs font-semibold uppercase tracking-[0.2em] text-slate-700 backdrop-blur dark:border-slate-700/70 dark:bg-slate-900/70 dark:text-slate-300">Resonance Lab Dispatch</Badge>
                        <h1 className="text-4xl font-semibold tracking-tight text-slate-900 dark:text-slate-50 sm:text-5xl">Bridging radio science and instrument craft.</h1>
                        <p className="text-lg text-slate-700 dark:text-slate-300">
                            <Balancer>K7RHY Resonance Lab explores resonance across radio, audio, and tactile builds—shaping gear that invites you to hear and feel signal paths differently, whether you're chasing clean transmitters or dialing in guitar tone.</Balancer>
                        </p>
                        <p className="text-base text-slate-600 dark:text-slate-400">
                            <Balancer>I'm K7RHY, an amateur radio tinkerer who splits time between bench-top RF explorations, 3D-printed guitar bodies, and documentation that keeps projects approachable. This space is where I collect the builds, notes, and playable results from ideas I'm working through.</Balancer>
                        </p>
