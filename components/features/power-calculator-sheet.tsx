        ...
        <Sheet>
            ...
            <SheetContent>
                <SheetHeader>
                    ...
                    <SheetDescription>Enter your measured voltage and frequency band to calculate the output power.</SheetDescription>
                </SheetHeader>

                <div className="grid gap-4 grid-4 mt-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label htmlFor="voltage" className="col-span-2 font-bold text-right">
                            Voltage (V):
                        </Label>
                        <Input id="voltage" name="voltage" type="text" placeholder="Voltage (V)" className="col-span-2" value={voltage} onChange={(e) => setVoltage(e.target.value)} />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label htmlFor="wattage" className="col-span-2 font-bold text-right">
                            Power (W):
                        </Label>
                        <Label htmlFor="wattage" className="p-3 col-span-2 font-bold text-black bg-blue-200 overflow-hidden rounded-lg">
                            {power !== null && <div className="ml-1">{power.toFixed(1)}</div>}
                        </Label>
                    </div>
