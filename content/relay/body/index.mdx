...
<DiscordThreadNudge channelHref="https://discord.com/channels/1432214244459417693/1506268185408831539" prompt="Questions about the body build?" />

## Steps

<CardGrid>
    <CardGridItem eyebrow="Step 1" title="Print" href="/guitars/relay/body/print">
        Download the model files, acquire the parts and materials, and print the model.
    </CardGridItem>
    <CardGridItem eyebrow="Step 2" title="Bonding" href="/guitars/relay/body/bonding">
        Bond the printed parts into a monolithic structure with G/Flex 650 epoxy.
    </CardGridItem>
    <CardGridItem eyebrow="Step 3" title="Finishing" href="/guitars/relay/body/finishing">
