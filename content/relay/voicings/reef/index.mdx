...
<RelayVoicingPickupChoices bridge="Bridge humbucker - target specs finalized during testing" middle="GFS Lipstick Tube Pickup, low-output target around 6K" neck="GFS Lipstick Tube Pickup, low-output target around 6K">
