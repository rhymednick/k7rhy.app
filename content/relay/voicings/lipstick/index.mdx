...
**Volume (push-push)** — Adds the lipstick shaper in parallel with the selected humbucker voice and partially splits the bridge through a resistor.

**Tone** — Standard A500k control with a 22 nF capacitor.
...
<RelayVoicingPickupChoices neck="GFS Professional Series Alnico II Humbucker" middle="GFS Pro-Tube Lipstick" bridge="GFS Vintage '59 humbucker">
