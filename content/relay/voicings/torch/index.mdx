...
**Volume** — A500k audio taper with no treble bleed. Rolling it back cleans up the amp and naturally softens the sound.

**Tone (push-pull)** — A500k modern master tone with a 22 nF (`223`) capacitor. Pull for the global Edge Contour: a 2.2 nF (`222`) capacitor in parallel with a 150 kΩ resistor, switched in series after the pickup selector. Down is the fuller, direct voice; up tightens the lows and emphasizes attack.
