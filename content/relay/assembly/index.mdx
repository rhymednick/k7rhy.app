...
By the time you reach assembly you've printed and finished the body, chosen your voicing, gathered the parts, and built and bench-tested the harness on the [Wiring](/guitars/relay/wiring) step. Assembly is where it all comes together into a playable guitar.
