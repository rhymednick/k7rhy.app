...
When an instrument is ready for a new owner, it's listed under [Coupeville instruments](/shop/coupeville). If nothing is listed there right now, or you want a specific voice built for you, reach out and I'll build one to order.
