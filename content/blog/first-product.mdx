...
date: 2024-09-03
summary: "Discover the story behind the 20W dummy load, K7RHY's first product for amateur radio enthusiasts. This post covers the design process, challenges, and innovations involved in creating an affordable, reliable dummy load for discreet radio testing. Learn about the experiments with PCB layouts, component selection, and the trade-offs made to achieve compatibility with HF and VHF bands. Also, get a sneak peek into the upcoming version."
