...
describe('CPC26001 permanent customer record', () => {
    it('documents the published identity and installed production specification', () => {
        ...
        for (const required of [
            ...
            'position="neck" type="humbucker" brand="GFS" model="Vintage 59 Humbucker"',
            'position="middle" type="filtertron" brand="GFS" model="Retrotron Hot Nashville"',
            'position="bridge" type="humbucker" brand="GFS" model="Professional Series Alnico V HOT Humbucker"',
