...
const recordPath = join(process.cwd(), 'content/instruments/CVL26001.mdx');
const placeholderPath = join(process.cwd(), 'public/images/instruments/CVL26001/placeholder.svg');

describe('CVL26001 permanent customer record', () => {
