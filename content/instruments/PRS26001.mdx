...
The factory electronics were replaced by a Seymour Duncan APH-1b/APH-1n Alnico II Pro set, an Oak Grigsby five-way blade, 500 kΩ master volume and push-pull tone controls, a 0.022 µF film tone capacitor, and approximately 1.8 kΩ partial-split resistors. The system was voiced as a coherent eight-sound instrument rather than as a collection of unrelated switching options.
